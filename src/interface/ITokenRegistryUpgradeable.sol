...
interface ITokenRegistryUpgradeable is IERC165Upgradeable {
    ...
    function mintToken(address to, bytes32 proofOfIntegrity, address royaltyReceiver) external returns (uint256);
    ...
    /**
     * @dev get the token id for a given owner and proof of integrity.
     */
