...
import {IEIP712} from "../interface/permit2/IEIP712.sol";

import {IDAIPermit} from "../interface/permit2/IDAIPermit.sol";
import {IAllowanceTransfer} from "../interface/permit2/IAllowanceTransfer.sol";
...
library Permit2Lib {
    ...
    /// @dev The address of the Permit2 contract for signature transfers.
    ISignatureTransfer internal constant PERMIT2_SIGNATURE =
    ...
    function permit2(
        ...
        bytes memory inputData = abi.encodeWithSelector(IEIP712.DOMAIN_SEPARATOR.selector);
